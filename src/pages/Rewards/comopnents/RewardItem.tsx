...
export const RewardItem: React.FC<RewardItemProps> = (props) => {
  ...
  return (
    <div
      className={classNames('flex justify-between rounded-[8px] border bg-white px-4 py-3 min-h-[70px]', {
        '!bg-gray-200': claimed
      })}
      key={reward.id}
    >
      <div className="flex flex-1 items-center gap-4">
        ...
        <div className="space-y-1">
          <div className="flex items-center">
            ...
            <div
              className={classNames('ml-2 h-[18px] rounded-full bg-secondary px-2 text-xs text-primary', {
